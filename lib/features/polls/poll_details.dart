  ...
  Future<void> _vote() async {
    ...
    if (user == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Треба да сте најавени за да можете да гласате'),
        ),
      );
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: pollAsync.when(
        ...
        data: (poll) {
          if (poll == null)
            return const Center(child: Text('Анкетата не е пронајдена'));
            ...
            child: Column(
              ...
              children: [
                ...
                if (!showResults && poll.isActive)
                  ElevatedButton.icon(
                    onPressed: (_voting || _selectedOptionId == null)
                        ? null
                        : _vote,
                    icon: _voting
                        ? const SizedBox(
