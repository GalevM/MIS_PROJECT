                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      Expanded(child: Column(children: [
                        Text('Поени', style: GoogleFonts.nunito(
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('Ранг', style: GoogleFonts.nunito(
                                fontSize: 12, color: AppTheme.textMuted, fontWeight: FontWeight.w700)),
                            const SizedBox(height: 4),
...
class _PointsProgress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    else return Text('Максимален ранг! 🏆',
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ClipRRect(
        ...
        child: LinearProgressIndicator(
          value: (points / next).clamp(0.0, 1.0), minHeight: 5,
          backgroundColor: const Color(0xFFECEFF1),
          valueColor: const AlwaysStoppedAnimation(AppTheme.accent),
        ),
      ),
      const SizedBox(height: 3),
      Text('$points / $next поени',
