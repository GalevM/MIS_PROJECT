...
class _AdminPollsPageState extends ConsumerState<AdminPollsPage> {
  ...
  Future<void> _create() async {
    ...
    if (q.isEmpty) {
      _snack('Внесете прашање');
      return;
    }
    if (opts.length < 2) {
      _snack('Потребни се минимум 2 опции');
      return;
    }
  ...
  void _confirmDelete(String id) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'Сите гласови ќе се изгубат. Сигурни сте?',
                ...
                Row(
                  children: [
                    ...
                    OutlinedButton.icon(
                      ...
                      label: Text(
                        poll.isActive ? 'Затвори' : 'Активирај',
                        style: GoogleFonts.nunito(fontSize: 11),
                      ),
                      style: OutlinedButton.styleFrom(
                        foregroundColor: poll.isActive
                            ? AppTheme.warning
                            : AppTheme.success,
                        side: BorderSide(
                          color: poll.isActive
