...
class NotificationsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Известувања')),
      body: notifs.when(
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Нема известувања', style: GoogleFonts.nunito(
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border(left: BorderSide(
                    color: n.isRead ? const Color(0xFFCFD8DC) : AppTheme.primary,
                    width: 4,
                  )),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Center(child: Text(n.typeEmoji, style: const TextStyle(fontSize: 22))),
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(DateFormat('dd.MM.yyyy HH:mm').format(n.createdAt),
                              style: GoogleFonts.nunito(fontSize: 11, color: AppTheme.textMuted, fontWeight: FontWeight.w700)),
                        ],
                      ),
                    ),
                    if (!n.isRead)
