    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/map', builder: (context, state) => const PublicMapPage()),
          GoRoute(path: '/myReports', builder: (context, state) => const MyReportsPage()),
          GoRoute(path: '/myProfile', builder: (context, state) => const ProfilePage()),
          GoRoute(path: '/report', builder: (context, state) => const ReportProblemPage()),
